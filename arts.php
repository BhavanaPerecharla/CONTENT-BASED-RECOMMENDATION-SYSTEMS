...
<head>
    ...
    margin-top: 55px;
        ...
        .sidenav {
           ...
           top: 0;
           left: 0;
           background: linear-gradient(135deg, #7b4397, #dc2430); /* Dark gradient for a stylish look */
           overflow-x: hidden;
           transition: width 0.5s ease-in-out, background 0.8s ease;
           padding-top: 40px;
           box-shadow: 5px 0 15px rgba(0, 0, 0, 0.5); /* Adds a shadow for depth */
        }
        ...
        .open-nav-btn {
            ...
            background-image: linear-gradient(45deg, #ff6a00, #ee0979); /* Vibrant gradient */
            border: none;
